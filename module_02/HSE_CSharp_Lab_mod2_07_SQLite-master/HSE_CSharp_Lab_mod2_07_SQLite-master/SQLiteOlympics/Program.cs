...
namespace SQLPrac
{
    ...
    class Program
    {
        ...
        private static string task04 = "SELECT e.name FROM Olympics o JOIN Events e ON  e.olympic_id == o.oplympic_id WHERE o.year == 2000";
        private static string task05 = "SELECT p.name, r.result,e.result_noted_in FROM Results r JOIN Players p ON p.player_id = r.player_id " +
